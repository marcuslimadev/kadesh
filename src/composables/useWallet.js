...
export function useWallet() {
  ...
  const fetchBalance = async () => {
    ...
    try {
      ...
      availableBalance.value = response.data.available_balance || 0
      escrowBalance.value = response.data.escrow_balance || 0
      totalReceived.value = response.data.total_received || 0
