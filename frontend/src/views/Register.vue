    ...
    <div class="max-w-md w-full">
      <div class="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 border-2 border-indigo-100">
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div class="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input v-model="form.password" type="password" 
                     class="w-full px-3 sm:px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 font-medium text-sm sm:text-base" 
          ...
          <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4 border-2 border-indigo-100">
            ...
            <div class="space-y-3">
              <label class="flex items-center space-x-3 cursor-pointer group">
                ...
                <div class="flex-1">
                  <div class="text-sm font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">👔 Contratante</div>
              ...
              <label class="flex items-center space-x-3 cursor-pointer group">
                <input type="checkbox" v-model="form.is_provider" 
                       class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded focus:ring-purple-500" />
                <div class="flex-1">
                  <div class="text-sm font-bold text-gray-900 group-hover:text-purple-600 transition-colors">⚡ Fornecedor</div>
          ...
          <div v-if="form.is_provider" class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border-2 border-blue-100 space-y-4">
            <div class="grid grid-cols-2 gap-3 sm:gap-4">
              <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">💼 Profissão</label>
                <input v-model="form.profession" 
                       class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-medium" 
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input v-model.number="form.hourly_rate" type="number" step="0.01" 
                         class="w-full pl-8 pr-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-medium" 
                         placeholder="0,00" />
                </div>
              </div>
            </div>
            <div>
              ...
              <textarea v-model="form.bio" rows="3" 
                        class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm resize-none font-medium" 
          ...
          <div v-if="emailExists" class="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-400 rounded-xl p-4 space-y-3">
              ...
              <div class="flex-1">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                  <router-link to="/login" 
                               class="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-center px-4 py-2 rounded-lg font-bold text-xs sm:text-sm transition-all shadow-md hover:shadow-lg transform hover:scale-105">
                    🔐 Fazer Login
                  </router-link>
                  <router-link to="/forgot-password" 
                               class="flex-1 bg-white hover:bg-gray-50 text-amber-700 border-2 border-amber-400 text-center px-4 py-2 rounded-lg font-bold text-xs sm:text-sm transition-all shadow-sm hover:shadow-md transform hover:scale-105">
                    🔑 Esqueci a Senha
                  </router-link>
                </div>
              </div>
          ...
          <!-- Outros erros -->
          <div v-else-if="error" class="bg-gradient-to-r from-red-50 to-rose-50 border-2 border-red-300 rounded-xl p-4">
