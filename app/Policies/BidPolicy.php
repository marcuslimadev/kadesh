...
class BidPolicy
{
    ...
    {
        return $user->id === $bid->provider_id || $user->id === $bid->project->contractor_id;
    }
    ...
    {
        return $user->id === $bid->provider_id && 
               $bid->status === 'pending' && 
               $bid->project->status === 'bidding';
    }
    ...
    {
        return $user->id === $bid->provider_id && $bid->status === 'pending';
    }
