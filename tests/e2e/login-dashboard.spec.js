...
const BASE_URL = 'http://localhost/kadesh';
...
test.describe('Fluxo de Login e Dashboard', () => {
    ...
    test('Deve mostrar erro com credenciais inválidas', async ({ page }) => {
        ...
        await page.goto(`${BASE_URL}/public/jquery-frontend/login.html`);
    ...
    test('Dashboard deve proteger acesso sem login', async ({ page }) => {
        ...
        await page.goto(`${BASE_URL}/public/jquery-frontend/dashboard.html`);
